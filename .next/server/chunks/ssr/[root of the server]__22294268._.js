    ...
    callbacks: {
        async signIn ({ user, account }) {
            ...
            if (!existingUser) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].user.create({
                    data: {
                        email: user.email,
                        name: user.name,
                        avatar: user.image,
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].user.update({
                    where: {
                        email: user.email
                    },
                    data: {
        ...
        async jwt ({ token }) {
            ...
            const dbUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].user.findUnique({
                where: {
                    email: token.email
                }
            });
        ...
        async session ({ session, token }) {
            if (session.user) {
                ...
                session.user.role = token.role; // Gán role vào session
            }
            return session;
        }
    },
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__22294268._.js.map