    ...
    callbacks: {
            ...
            if (!existingUser) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.create({
                    data: {
                        ...
                        role: "user",
                        currentSessionToken: account?.access_token
                    }
                });
            } else {
        ...
        async session ({ session, token }) {
            if (session.user) {
                ...
                session.user.currentSessionToken = token.currentSessionToken; // Lưu token vào session
            }
            return session;
        }
    },
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__55265255._.js.map